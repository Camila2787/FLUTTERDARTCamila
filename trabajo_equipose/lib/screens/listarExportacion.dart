              ...
              return Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                    ...
                    'Precio Actual Dólar: ${exportacion.precioDolar}',
                  ),
                  trailing: Row(
                        ...
                        onPressed: () {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content:
                                  const Text('¿Está seguro de eliminar esta exportación?'),
                              actions: [
                                TextButton(
                                  ...
                                  onPressed: () {
                                    Exportaciones.eliminarExportacion(exportacion.producto)
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        const SnackBar(content: Text('Exportación eliminada')),
                                      );
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration:
                  const InputDecoration(labelText: 'Precio Actual Dólar'),
              keyboardType: TextInputType.number,
            ),
          ],
        ),
          ...
          TextButton(
            onPressed: () {
              ...
              Exportaciones.editarExportacion(nuevaExportacion)
                  .then((_) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Exportación editada')),
                );
                Navigator.pop(context);
                setState(() {});
              }).catchError((error) {
